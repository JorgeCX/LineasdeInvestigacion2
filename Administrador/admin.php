...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">    
    <title>Lineas-Administrador.</title>
...
<body>
	...
	<div class="container" >
        <hr >	
		<h3>Solicitud de Líneas de Investigación Pendientes.</h3>
        <hr />
...
$(document).ready(function(){
	var table = $('#resultTable');
        ...
        table.bootstrapTable({
			method: 'get',
            url: "/LineasdeInvestigacion/handler/index.php?accion=getHistorial",
            cache: false,
            search: true,
            striped: false,
            pagination: false,
...
function AddButon(value,row)
{
	return 	'<div class="group-form">'
			+'<button class="btn btn-primary" id="btnEditar"><span class="glyphicon glyphicon-pencil" ></span></button>'
			+'<button class="btn btn-danger" id="btnEliminar"><span class="glyphicon glyphicon-remove" ></span></button>'
			+'</div>';
}
